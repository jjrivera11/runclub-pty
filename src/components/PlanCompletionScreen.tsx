      ...
      <div className="w-full max-w-sm space-y-6 text-center">
        ...
        {!showOptions ? (
          <div className="space-y-3">
            <a
              href={`/api/share-card?type=complete&name=${encodeURIComponent(fullName ?? "Atleta")}&race=${encodeURIComponent(raceName)}&weeks=${totalWeeks}&streak=${streak}&track=${track}&totalkm=${totalKm}&pct=${completionPercent}`}
              target="_blank"
              rel="noopener noreferrer"
              className="flex w-full items-center justify-center gap-2 rounded-lg border border-[#707070] px-4 py-3 text-sm text-[#B8B8B8] hover:border-[#F16823] hover:text-[#F16823] transition-colors"
            >
