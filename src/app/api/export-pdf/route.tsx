        ...
        <View style={styles.header}>
          <View style={styles.headerLeft}>
            <View style={{ flexDirection: "row", alignItems: "center", gap: 8 }}>
              <Svg width="20" height="26" viewBox="0 0 261 345">
              ...
              <View>
                <Text style={styles.logoText}>RUN<Text style={{ color: ORANGE }}>CLUB</Text></Text>
                <Text style={styles.logoSub}>PANAMÁ · runclubpty.com</Text>
              </View>
            </View>
          </View>
