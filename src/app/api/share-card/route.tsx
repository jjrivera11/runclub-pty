...
export async function GET(request: Request) {
  ...
  // Cargar fuente bold desde el proyecto
  const fontData = await fetch(`${origin}/fonts/Inter-Bold.ttf`).then(r => r.arrayBuffer()).catch(() => null);
  ...
  try {
    return new ImageResponse(
      (
        <div style={{ width: "400px", height: "400px", background: "#111111", display: "flex", flexDirection: "column", justifyContent: "space-between", padding: "36px", fontFamily: fontData ? "Inter" : "sans-serif", position: "relative" }}>
